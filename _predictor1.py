...
# load model
model1 = tf.keras.models.load_model('/path/to/your/model1')
...
for batch in dataset:
    ...
    predictions = model1.predict(crops_batch, batch_size=batch_size)
...
predictions1= tf.nn.softmax(all_predictions).numpy()

# Specify the filename
filename = '/path/to/your/predictions1'

# Save the array to a file using pickle
with open(filename, 'wb') as file:
    pickle.dump(predictions1, file)

print(f"predictions1 saved as {filename}")
