...
# load model
model3 = tf.keras.models.load_model('/path/to/your/model3')
...
for batch in dataset:
    ...
    predictions = model3.predict(crops_batch, batch_size=batch_size)
...
predictions3= tf.nn.softmax(all_predictions).numpy()

# Specify the filename
filename = '/path/to/your/predictions3'

# Save the array to a file using pickle
with open(filename, 'wb') as file:
    pickle.dump(predictions3, file)

print(f"predictions3 saved as {filename}")
